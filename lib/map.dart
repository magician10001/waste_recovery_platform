...
class _AMapPageState extends State<AMapPage> with AMapLocationStateMixin {


  @override
  String get iosKey => widget.iosKey;

  @override
  String get androidKey => widget.androidKey;
  ...
  get latLng => widget.latLng;

  get onMapCreated => widget.onMapCreated;
